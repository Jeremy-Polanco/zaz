...
const ACCESS_KEY = 'dashgo.access_token'
const REFRESH_KEY = 'dashgo.refresh_token'

// Legacy keys used before this migration — kept for one-time migration only.
const LEGACY_ACCESS_KEY = 'dashgo.accessToken'
const LEGACY_REFRESH_KEY = 'dashgo.refreshToken'
