...
export function Button({
  ...
  const loaderColor =
    variant === 'ink' ? '#FAFAFC' : variant === 'accent' ? '#0A0A0A' : '#1A1530'
  return (
    <Pressable
...
// ─── DashGo design system: Brand mark, bolt, status stepper, speed banner ───
